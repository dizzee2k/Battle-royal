...
const pokemonData = [
    ...
    // Total: 29 Pokémon added (can add more if needed)
];
...
const moveData = {
    ...
    'Poison Sting': { baseDamage: 15, accuracy: 90, type: 'Poison' },
    'Glare': { baseDamage: 0, accuracy: 90, type: 'Normal', status: true },
    'Poison Fang': { baseDamage: 20, accuracy: 85, type: 'Poison' },
    ...
    // Added more moves to match new Pokémon
};
    ...
    try {
        ...
        if (commandName === 'attack') {
            ...
            if (battle.players.size > 0) {
                ...
                // No need for announceMoveOptions since moves are now in autocomplete
            }
